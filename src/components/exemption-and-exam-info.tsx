...
export default function ExemptionAndExamInfo({
  ...
  console.log(totalExamFee);

  return (
    <>
      {isQualification === "none" ? (
        <>
          <h1 className="flex justify-center items-center h-[450px] text-[32px] text-center">
            Select a qualification to view your exemptions and required exams.
          </h1>
        </>
      ) : (
          ...
          <div className=" md:flex md:justify-between md:mt-10">
            <div className="md:w-[40%]">
              ...
              <p className="text-[13px]">
                Based on your qualification, you are eligible for the following
                exemptions:
              </p>
            ...
            <div className=" mt-10 md:mt-0 md:w-[40%]">
              ...
              <p className="text-[13px]">
                You are required to write the following exams at there
                respective levels:
              </p>
              <div className="p-4 mt-5 border border-black/70 rounded-md space-y-3">
                {exams.map((value) => (
